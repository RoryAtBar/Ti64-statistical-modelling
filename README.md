...
A python notebook tool for digitising literature stress-strain and beta volume fraction data for use in comparison against experimental and modelling data.
...
Further attributes to the data may be added such as:
 - Strain rate
 - Temperature
 - Microstructure
 - Local chemistry
